...
public class App {
    ...
    public static ConsoleControl setupConsoleControl() throws SQLException, ClassNotFoundException {
        ConsoleControl consoleControl = new ConsoleControl();
        AmmunitionFactory ammunitionFactory = new AmmunitionFactoryImpl();
        AmmunitionController ammunitionController = new AmmunitionController(new AmmunitionService());
